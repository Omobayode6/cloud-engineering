...
system log info are stores in /var/log. /var/log/journal is the journal log info directory
  ...
  * 
  ...
  ## How to SSH between two machines
  
  * create two ubuntu in the same folder but with different name. e.g vagrant/boxes/ubuntu and vagrant/boxes/ubuntu20.4-LTS
  * open two tabs of terminals
  * vagrant up on both machine
  * vagrant global-status - to check the two machines you have on you system and their id. run it on one of the machine.
  * vagrant ssh on both machine  
  
  * Machine1 - ssh-keygen - to generate key for machine 1
  ...
  * Machine 1 - ssh-copy-id -i vagrant@ipaddress_of_machine2 - to copy the machine1 pub key to machine2 (use ifconfig to get machine2 ip address) or cat ~/.ssh/id_rsa.pub to get the public key
  ...
  * machine1 - ssh vagrant@machine2ipaddress - you have successfully login to machine2 from machine1  
  ...
  In Summarry...  
  Machine1 - generate key | copy key to machine2 | logine to machine2
